...
if(xtensor_FOUND AND xtensor-blas_FOUND)
  ...
  macro(add_xtensor_executable name source)
    ...
    if(${xtensor_VERSION} VERSION_GREATER_EQUAL 0.26)
      set_property(TARGET ${name} PROPERTY CXX_STANDARD 20)
      target_compile_definitions(${name} PRIVATE -DXTENSOR_HEADERS_IN_SUBDIRS)
    else(${xtensor_VERSION} VERSION_GREATER_EQUAL 0.26)
      set_property(TARGET ${name} PROPERTY CXX_STANDARD 14)
    endif(${xtensor_VERSION} VERSION_GREATER_EQUAL 0.26)
