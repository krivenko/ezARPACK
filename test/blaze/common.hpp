...
void check_eigenvectors(arpack_solver<MKind, blaze_storage> const& ar,
                        M const& A) {
...
void check_eigenvectors_shift_and_invert(
    arpack_solver<Asymmetric, blaze_storage> const& ar,
    MT const& A,
    MT const& M) {
  using solver_t = arpack_solver<Asymmetric, blaze_storage>;
...
auto get_basis_vectors(arpack_solver<Symmetric, blaze_storage> const& ar)
...
auto get_basis_vectors(arpack_solver<MKind, blaze_storage> const& ar)
...
template<operator_kind MKind>
void check_basis_vectors(arpack_solver<MKind, blaze_storage> const& ar) {
