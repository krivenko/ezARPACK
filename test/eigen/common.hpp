...
void check_eigenvectors(arpack_solver<MKind, eigen_storage> const& ar,
                        M const& A) {
...
auto get_basis_vectors(arpack_solver<MKind, eigen_storage> const& ar)
...
template<operator_kind MKind>
void check_basis_vectors(arpack_solver<MKind, eigen_storage> const& ar) {
